...
///
/// 構成: 静止 4 (warm/cool/hi_key/dark_mood) + 動画 6 (drift/breathe/twinkle/wander/aurora/dream)。
/// 色相 / 明度 / クラスタ数 / 動きの 4 軸でバラつきを作り、同じ入力でも 10 通りの異なる
/// 印象が出るように調整。動画は 6 秒に統一して動きが見やすい長さにする。
///
