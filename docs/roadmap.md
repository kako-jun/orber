...
- [x] **#230**: orber-wasm に WebGPU 最小経路（canvas surface + Circle）— wasm32 専用
...
- [ ] **#231**: Glyph / Image / Aquarelle をブラウザ WGSL に配線
- [ ] **#232**: Studio に WebGL↔WGSL トグル A/B
- [ ] **#233**: Aquarelle Web 初公開
